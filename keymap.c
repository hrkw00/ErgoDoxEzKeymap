 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  '"  | LAlt | LCmd | ~L1  |                                       | ~L1  | RCmd |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(
  ...
  LT(SYMB,KC_GRV), KC_QUOT,     KC_LALT,       KC_LCMD, TT(SYMB),
  ...
  TT(SYMB),     KC_RCMD, KC_LBRC, KC_RBRC, TT(SYMB),
...
[SYMB] = LAYOUT_ergodox(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC,  KC_F12,
  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PPLS, KC_EQL,
